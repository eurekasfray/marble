...
class Response 
{
  ...
  //const HTTP_UNORDERED_COLLECTION = 425;                  // RFC 2817
    ...
    /**
     * @var array The HTTP response reason phrases.
     */
    ...
    /**
     * @var string The reason phrase of the response.
     */
    private $statusText;
    
    /**
     * @var string The protocol version of the response.
     */
    ...
    {
        // Have headers already been sent? (So what if headers have already been sent?? What does that mean?? What are the consequences??)
        if (headers_sent()) {
            return;
        }
